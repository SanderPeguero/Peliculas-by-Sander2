...
import { Text, InputGroup, Input, Button, InputLeftAddon, InputRightAddon, Divider } from '@chakra-ui/core'
...
const BalanceChecker = () => {
    ...
    //Funcion para checar el balance
    ...
    return (
        ...
        {checkedAccount?.balances.map(({ balance, asset_type }, index) => (
            <InputGroup mt={2} key={index}>
                <InputLeftAddon>Numero: {index}</InputLeftAddon>
